...
public:
    ...
    tensor_t forward(tensor_t x, size_t pos) {
        ...
        // 2. Reshape to multi-head format [seq, heads, head_dim]
        ...
        // 3. Create position tensor for RoPE
        ...
        // 6. Perform attention using cache
        ...
        // Create views for valid cached sequences
