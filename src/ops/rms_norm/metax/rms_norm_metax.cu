/**
 * @file rms_norm_metax.cu
 * @brief RMSNorm 算子的 MetaX MACA 实现
 *
...
void launch_rms_norm(
    ...
    case LLAISYS_DTYPE_BF16:
        ...
        break;
    default:
        throw std::invalid_argument("Unsupported dtype for MACA rms_norm");
    }

    checkMaca(cudaGetLastError(), "Failed to launch rms_norm kernel");
}
