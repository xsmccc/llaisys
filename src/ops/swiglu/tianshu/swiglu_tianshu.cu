/**
 * @file swiglu_tianshu.cu
 * @brief SwiGLU 算子的 Tianshu TOPSRIDER 实现
 *
...
void launch_swiglu_kernel(
    ...
    case LLAISYS_DTYPE_BF16:
        ...
        break;
    default:
        throw std::invalid_argument("Unsupported dtype for TOPSRIDER swiglu");
    }

    checkTops(cudaGetLastError(), "Failed to launch swiglu kernel");
}
