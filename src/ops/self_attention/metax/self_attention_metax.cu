/**
 * @file self_attention_metax.cu
 * @brief Causal Self-Attention 算子的 MetaX MACA 实现（融合 kernel）
 *
...
void self_attention(
    ...
    checkMaca(cudaGetLastError(), "self_attention_fused kernel launch failed");
}
