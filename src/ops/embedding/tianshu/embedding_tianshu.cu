...
void launch_embedding_typed(
    ...
    case LLAISYS_DTYPE_BF16:
        ...
        break;
    default:
        throw std::invalid_argument("Unsupported dtype for TOPSRIDER embedding");
    }

    checkTops(cudaGetLastError(), "Failed to launch embedding kernel");
}
...
void embedding(
    ...
    if (index_dtype == LLAISYS_DTYPE_I64) {
        ...
        throw std::invalid_argument("Unsupported index dtype for TOPSRIDER embedding");
    }
}
